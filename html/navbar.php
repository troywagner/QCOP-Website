	...
	<div class="container">
		...
		<div class="navbar-collapse collapse" class="">
			<ul class="nav navbar-nav navbar-right" >
				<li class="">
					<a href="https://qcop.ca#about" style="padding:0px 0px;" class="navbar_item" id="about_item">
				...
				<li class="">
					<a href="https://qcop.ca/connect" style="padding:0px 0px;" class="navbar_item" id="connect_item">
